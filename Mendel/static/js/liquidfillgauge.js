...
function loadLiquidFillGauge(divid, dataset) {
	var config2 = liquidFillGaugeDefaultSettings();
    config2.circleColor = "#66cc94";
    config2.textColor = "#2d8655";
    config2.waveTextColor = "#20603d";
    config2.waveColor = "#39ac6d";
    ...
    var   gaugediv=d3.select(divid);
    
    

	var margin = {top: 30, right: 5, bottom: 20, left: 0},
    width = parseInt(gaugediv.style("width")) - margin.left - margin.right,
	...
	var config = config2;
	     ...
	     var value = 0;
     for (x in dataset) {
             value=dataset[x].measure;
             
         }
    var gauge = d3.select(divid).append('svg')
    ...
    var locationY = parseInt(height)/2+margin.top - radius;
